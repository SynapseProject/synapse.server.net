...
namespace Synapse.Services
{
    ...
    {
        void CancelPlan(string planUniqueName, long planInstanceId, string nodeUrl = null);
        ...
        long StartPlan(string planUniqueName, bool dryRun = false, string requestNumber = null, string nodeUrl = null);
        long StartPlan([FromBody] StartPlanEnvelope planEnvelope, string planUniqueName, bool dryRun = false, string requestNumber = null, string nodeUrl = null);
        string WhoAmI();
    }
}